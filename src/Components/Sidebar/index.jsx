...
const Sidebar = () => {
    ...
    return(
        ...
        <aside className={`${ isVisibleDetail || isVisibleCart ? 'flex' : 'hidden' } product-detail flex flex-col fixed right-0 z-10 top-[68px] border border-black rounded-lg bg-white overflow-y-auto w-[360px] h-calc shadow-lg py-4`}>
            <span
